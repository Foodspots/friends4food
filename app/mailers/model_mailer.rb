class ModelMailer < ActionMailer::Base
  ...
  def new_follower_notification(user, current_user)
    ...
    mail to: @user.email, subject: "#{@user.name}, you are now followed by #{current_user.name}.", bcc: "oliviervanhees@gmail.com"; "jasper.admiraal@gmail.com"; "foodspotsjeroen@gmail.com"
  end
